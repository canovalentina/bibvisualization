...
var trelloKey = "b48d0a0508e2a98eff4bfcce46f55311";
var cards;
var lists;
var labels;
...
$(document).ready(function() {
	console.log("READY");
	$.get(
		"https://api.trello.com/1/boards/5aee1fd0624ab2beb8f1d4a0?key="+trelloKey+"&cards=open&lists=open",
		{},
		function(data) {
			cards = data.cards;
			lists = data.lists;
			...
			var idAttachment = "5aee1fd0624ab2beb8f1d4a0";
	...
	function init() {
		...
		for ( var i = 0; i < cards.length; i ++ ) {
			...
			//symbol.textContent =  //i;//cards[i]["name"];
